  ...
  $(".slide__slot").droppable({
    ...
    drop: function(event, ui) {
      ...
      if (currentProductId === 1) {
        $(this).addClass('product--1');
      } else if (currentProductId === 5) {
        $(this).addClass('product--5');
      } else if (currentProductId === 7) {
        $(this).addClass('product--7');
      } else if (currentProductId === 8) {
        $(this).addClass('product--8');
      }
